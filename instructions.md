...
- **Configure Enable Banking** — paste the application ID and private key from your Enable Banking control panel, and the Data Importer can pull transactions straight from your banks. Without them only file imports work.
